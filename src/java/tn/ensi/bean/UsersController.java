package tn.ensi.bean;

import tn.ensi.entities.Users;
import tn.ensi.bean.util.JsfUtil;
import tn.ensi.bean.util.JsfUtil.PersistAction;
import tn.ensi.dao.UsersFacade;
...
public class UsersController implements Serializable {
    ...
    @EJB
    private tn.ensi.dao.UsersFacade ejbFacade;
